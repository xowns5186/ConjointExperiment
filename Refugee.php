...
$featurearray = array("교육 수준" => array("교육 받은 적 없음","초등 과정에 해당하는 교육 이수","중등 과정에 해당하는 교육 이수","고등 과정에 해당하는 교육 이수","대학생","학사 학위 소지자","석/박사 이상"),"성별" => array("여성","남성"),"한국어 능력" => array("한국어 전혀 못함","한국어를 약간 할 줄 알지만 의사소통 불가능","의사소통이 어느정도 가능함","유창한 한국어"),"직업" => array("농업/목축업","정원사","간호사","선생님","건설노동자","금융분석가","기자","자영업자","의사","군인","과학자","교수"),"직업 경력" => array("경력없음","1~2년","3~5년","5년 이상"),"난민 신청 이유" => array("내전/전쟁","종교적 박해","민주화운동에 대한 탄압","기후변화로 인한 영토소실"),"민족" => array("한국계","한국계 아님"));
